    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          style={{ display: 'flex', justifyContent: 'center', marginTop: '140px', marginBottom: '20px', pointerEvents: 'none' }}
        >
          <img
            src={`/speaker/frame_0${frame}_transparent.png`}
            alt=""
            draggable={false}
            style={{ width: '200px', height: '200px', objectFit: 'contain', filter: 'drop-shadow(0 0 16px rgba(0,255,180,0.35))' }}
          />
        </motion.div>
      )}
    </AnimatePresence>
